...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "222";
	private final static String CLIENT_SECRET = "333";
	private final static String REDIRECT_URI = "http://localhost:9090/myapp/login/oauth2/naver";
