...
<html>
  <head>
    ...
    <link
      rel="shortcut icon"
      href="https://ounwan.s3.ap-northeast-2.amazonaws.com/1704307233380.png"
    />
    ...
    <link
      href="${appPath}/css/guest/guestOrderListModal.css"
      rel="stylesheet"
    />
  </head>
  <body>
      ...
      <div id="guestModal">
        <div class="guest-check-container">
          ...
          <div class="guest-check-content">
            ...
            <button
              type="button"
              class="guest-check-button"
              onclick="checkGuestInfo()"
            >
              확인
            </button>
          </div>
