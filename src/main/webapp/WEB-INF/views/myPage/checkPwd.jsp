...
.button-container {
    ...
    justify-content: space-between; /* 요소 사이의 공간을 최대화하여 배치 */
}
...
.pwd-check input::placeholder {
	color: #aaaaaa;
}

.pwd-check input:focus {
	outline: none;
}
				...
				<div class="content-container">
					<div class="preview-container">
						...
						<div class="preview menu">
							...
							</a> <a href="#" class="preview-menu wish-list">
								<div>
									<img class="preview-menu-image">
									<div class="preview-menu-text">
										<p>관심 상품</p>
						...
						<div class="content-info">
							<div class="pwd-check-wrap-1 float-right">
								<p>비밀번호 재확인</p>
									...
									<div class="pwd-check">
										<input id="pwd-checkPassword" type="password" required value="jj123456!">
	...
	$("#confirmButton").on("click", function() {
	    ...
	    $.ajax({
	        ...
	        success: function(res) {
	            if (res === "success") {
	                window.location.href = "${appPath}/myPage/modifyUserInfo"; // 비밀번호 확인 성공 시 페이지 이동
	            } else {
	                // 비밀번호 확인 실패 처리
