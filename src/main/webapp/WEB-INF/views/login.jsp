  ...
  <body>
    ...
    <div class="container">
      <div class="login-menu">
        <div>
          <a href="#" class="login-menu-selected" id="loginAccount"
            >&nbsp;로그인&nbsp;</a
          >
        </div>
        <div class="float-right">
          <a href="#" id="findAccount">&nbsp;아이디/비밀번호 찾기&nbsp;</a>
        </div>
      </div>
      <!-- 로그인 -->
      <div class="login-container" id="loginAccountSelected">
        ...
        <div class="social-wrap">
          <a href="#"
            ><img class="login login-radius" src="../images/google.png" /></a
          ><br />
          <a href="${appPath}/clients/login/naver"
            ><img class="login login-radius" src="../images/naver_btn.png" /></a
          ><br />
          <a href="${appPath}/clients/login/kakao"
            ><img class="login login-radius" src="../images/kakao.png" /></a
          ><br />
        </div>
        ...
        <div class="login-wrap-1 float-right">
          ...
          <div class="login-sub">
            <a class="login-sub-1" href="#"
              >회원이 아니신가요? 지금 가입하세요!</a
            >
          </div>
          <div class="login-sub">
            <a class="login-sub-2" href="#">비회원 주문조회</a>
          </div>
        </div>
      </div>
      <!-- 아이디/비밀번호 찾기 -->
      <div class="login-container" id="findAccountSelected" hidden>
        ...
        <div class="find-guide">
          * 회원가입 시 사용하신 이메일 주소를 통해 아이디/비밀번호를 찾으실 수
          있습니다.
        </div>
      </div>
    </div>
