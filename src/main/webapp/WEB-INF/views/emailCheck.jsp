            ...
            <div class="email-input-container">
                <form>
                    ...
                    <p class="emailCheckPart_T">아이디</p>
                        <input type="text" placeholder="아이디를 입력하세요" id="clientId" required/>
                       </div>
                       <div class="emailPart">
                       <p class="emailCheckPart_T">인증키</p>
                        <input type="text" placeholder="인증키를 입력하세요" id="emailAuth" required/>
                        </div>
                        <div class="checkBtnPart">
                        <button id="emailAuthBtn" type="button">인증하기</button>
    					</div>
                    </div>
                </form>
            </div>
