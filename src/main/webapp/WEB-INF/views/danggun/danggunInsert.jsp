...
<link href="${appPath}/css/danggunProhibitedListModal.css"
	rel="stylesheet" />
		...
		<div class="danggun-container">
			<div>
				<div class="register-container">
					<div class="register-info">당군 상품 등록 기본정보</div>
				...
				<div class="register-content">
					<div class="danggun-product">
						...
						<div class="danggun-image">
							<label for="imageInput"></label> <input type="file"
								id="imageInput" name="dnaggunImage" class="input-file" /> <img
								id="mainPreview" src="../images/danggunInsertDefault.png">
						</div>
					</div>
					<div class="danggun-product">
						<div class="danggun-product-text">
						...
						<div class="danggun-images" id="detailImageContainer">
							<div class="danggun-image">
								<label for="detailInput"></label> <input type="file"
									id="detailInput" name="dnaggunImage" class="input-file"
									onchange="setDetailImages(event)" multiple /> <img
									id="DetailPreview1" class="detail-preview"
									src="../images/danggunInsertDefault.png">
							</div>
							<div class="danggun-image">
								<label for="imageInput2"></label> <img id="DetailPreview2"
									class="detail-preview" src="../images/danggunInsertDefault.png">
							</div>
							<div class="danggun-image">
								<label for="imageInput2"></label> <img id="DetailPreview3"
									class="detail-preview" src="../images/danggunInsertDefault.png">
							</div>
						</div>
					</div>
					<div class="danggun-product">
						...
						<div class="text-input-name">
							<input placeholder="상품명을 입력해주세요" name="danggunName"
								id="danggunName" />
					...
					<div class="danggun-product">
						...
						<input placeholder="가격을 입력해주세요" name="danggunPrice"
							id="danggunPrice" type="number" />
					</div>
					<div class="danggun-product-description">
						...
						<div class="text-input-description">
							<textarea
								...
								name="danggunDescription" id="danggunDescription"></textarea>
						...
						.on(
								...
								function() {
									...
									if (detailImageCount === 0) {
										formData
												.append('detailImagesLength', 0);
										formData.append('detailImages', null);
									} else {
										formData.append('detailImagesLength',
												detailLength);
										for (var i = 0; i < detailLength; i++) {
											formData.append('detailImages',
													detailImages[i]);
										}
									}
									...
									formData.append('productName', $(
											"#danggunName").val());
									formData.append('price', $("#danggunPrice")
											.val());
					...
					.addEventListener(
							...
							function() {
								const textArea = document
										.getElementById("danggunDescription");
								const detailCounter = document
										.getElementById("detailCount");
								const detailMaxLength = 2000;

								updateCounter(textArea, detailCounter,
										detailMaxLength);
								...
								const input = document
										.getElementById("danggunName");
								const nameCounter = document
										.getElementById("nameCount");
								const nameMaxLength = 40;

								updateCounter(input, nameCounter, nameMaxLength);
								input.addEventListener("input", function() {
									updateCounter(input, nameCounter,
											nameMaxLength);
								});

								function updateCounter(inputElement,
										counterElement, maxLength) {
